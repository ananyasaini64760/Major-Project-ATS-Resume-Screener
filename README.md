...
A Streamlit web app that screens resumes against a job description using NLP + TF-IDF + SVM. Check out(https://major-project-ats-resume-screener.streamlit.app/).
